...
$output .= '<style>
.knowledge-areas-wrapper .btn {
    background-image: none !important;
    box-shadow: none !important;
}

.knowledge-areas-wrapper .btn-primary {
    background-color: #0d6efd;
    border-color: #0d6efd;
}

.knowledge-areas-wrapper .btn-primary:hover {
    background-color: #0b5ed7;
    border-color: #0a58ca;
}

.knowledge-areas-wrapper .btn-success {
    background-color: #198754;
    border-color: #198754;
}

.knowledge-areas-wrapper .btn-success:hover {
    background-color: #157347;
    border-color: #146c43;
}

.knowledge-areas-wrapper .btn-info {
    background-color: #0dcaf0;
    border-color: #0dcaf0;
    color: #000;
}

.knowledge-areas-wrapper .btn-info:hover {
    background-color: #31d2f2;
    border-color: #25cff2;
    color: #000;
}

.knowledge-areas-wrapper .btn-warning {
    background-color: #ffc107;
    border-color: #ffc107;
    color: #000;
}

.knowledge-areas-wrapper .btn-warning:hover {
    background-color: #ffca2c;
    border-color: #ffc720;
    color: #000;
}

.knowledge-areas-wrapper .btn-danger {
    background-color: #dc3545;
    border-color: #dc3545;
}

.knowledge-areas-wrapper .btn-danger:hover {
    background-color: #bb2d3b;
    border-color: #b02a37;
}

.knowledge-areas-wrapper .btn-secondary {
    background-color: #6c757d;
    border-color: #6c757d;
}

.knowledge-areas-wrapper .btn-secondary:hover {
    background-color: #5c636a;
    border-color: #565e64;
}

.knowledge-areas-wrapper .card {
    transition: transform 0.2s ease, box-shadow 0.2s ease;
}

.knowledge-areas-wrapper .card:hover {
