...
if ($knowledgeAreaId > 0) {
    ...
    // Заголовок теста/области: над прогресс-баром, с пониженным визуальным акцентом
    ...
    $output .= '</div>';
    $output .= '<div class="card-body">';
    $output .= '<h3 id="test-title-heading" class="mb-3">' . htmlspecialchars($knowledgeArea['name'], ENT_QUOTES, 'UTF-8') . '</h3>';
...
$output .= '<div id="question-container" style="display:none;">';
// Заголовок теста: над прогресс-баром, с пониженным визуальным акцентом
...
$output .= '</div>';
$output .= '<div class="card-body">';
$output .= '<h3 id="test-title-heading" class="mb-3">' . htmlspecialchars($test['title'], ENT_QUOTES, 'UTF-8') . '</h3>';
$output .= '<h4 id="question-text"></h4>';
$output .= '<div id="question-type-hint" style="display: none;"></div>';
$output .= '<div id="answer-options" class="mt-3"></div>';
$output .= '<div id="explanation-block" class="ts-alert ts-alert-info mt-3" style="display:none;"></div>';
