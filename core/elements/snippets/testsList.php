<?php
/**
 * Сниппет: testsList - Список тестов категории
 * Вызывается из: MODX ресурсов (страница списка тестов)
 * Назначение: Отображает список доступных тестов в выбранной категории
 *
 * @package TestSystem
 * @version 1.0
 */
