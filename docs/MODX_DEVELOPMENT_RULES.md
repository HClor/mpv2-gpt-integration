...
### 2. Короткий синтаксис массивов `[]` - ПРОБЛЕМЫ С СОВМЕСТИМОСТЬЮ

**ПРОБЛЕМА:** В некоторых конфигурациях MODX/Fenom короткий синтаксис `[]` может вызывать проблемы.
...
### 3. HEREDOC с JavaScript - ОСТОРОЖНО
