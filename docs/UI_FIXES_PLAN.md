...
## ~~ЭТАП 4~~ ✅ ВЫПОЛНЕНО — Убрать заголовки и хлебные крошки из сниппетов
...
## ~~ЭТАП 5~~ ✅ ВЫПОЛНЕНО (код) / ⚠️ ТРЕБУЕТ РУЧНЫХ ДЕЙСТВИЙ В MODX ADMIN — Верхнее главное меню: динамические названия через pdoMenu
...
## ~~ЭТАП 6~~ ✅ ВЫПОЛНЕНО — `manageCategories`: кнопки + форма добавления в модале
